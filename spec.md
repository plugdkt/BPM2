...
- [ ] การ mapping "รายการ" แต่ละอันเข้ากับ `budget_groups` (6 กลุ่มใหญ่สำหรับกราฟสรุป) จะให้ ADMIN เลือกเองตอน import/สร้างแต่ละรายการ หรือมีกฎ mapping อัตโนมัติจากคำขึ้นต้นชื่อรายการ (เช่น ขึ้นต้นด้วย "ค่าตอบแทน" → กลุ่มค่าตอบแทน) — ถ้าไม่กำหนดไว้ กราฟเปรียบเทียบหมวดงบบน dashboard จะว่างเปล่าจนกว่าจะ tag ครบ
